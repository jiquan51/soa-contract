...
public class TExpBc extends BaseEntity implements Serializable {
	...
	private String planSalesInlOrOs;

	private String gjFctName;
	...
	public String getPlanSalesInlOrOs() {
		return planSalesInlOrOs;
	}

	public void setPlanSalesInlOrOs(String planSalesInlOrOs) {
		this.planSalesInlOrOs = planSalesInlOrOs;
	}

	public String getGjFctName() {
		return gjFctName;
	}

	public void setGjFctName(String gjFctName) {
		this.gjFctName = gjFctName;
	}
	...
	public boolean equals(Object that) {
		...
		return (this.getBcId() == null ? other.getBcId() == null : this.getBcId().equals(other.getBcId()))
				...
				&& (this.getFirstParty() == null ? other.getFirstParty() == null
						: this.getFirstParty().equals(other.getFirstParty()))
				&& (this.getPackTrm() == null ? other.getPackTrm() == null
						: this.getPackTrm().equals(other.getPackTrm()))
				&& (this.getQuality() == null ? other.getQuality() == null
						: this.getQuality().equals(other.getQuality()))
				&& (this.getQualityTime() == null ? other.getQualityTime() == null
						: this.getQualityTime().equals(other.getQualityTime()))
				&& (this.getDepature() == null ? other.getDepature() == null
						: this.getDepature().equals(other.getDepature()))
				...
				&& (this.getStatusPs() == null ? other.getStatusPs() == null
						: this.getStatusPs().equals(other.getStatusPs()))
				...
				&& (this.getMakerNo() == null ? other.getMakerNo() == null
						: this.getMakerNo().equals(other.getMakerNo()))
				&& (this.getMakerName() == null ? other.getMakerName() == null
						: this.getMakerName().equals(other.getMakerName()))
				&& (this.getModifyNo() == null ? other.getModifyNo() == null
						: this.getModifyNo().equals(other.getModifyNo()))
				&& (this.getModifyName() == null ? other.getModifyName() == null
						: this.getModifyName().equals(other.getModifyName()))
				&& (this.getModifyDate() == null ? other.getModifyDate() == null
						: this.getModifyDate().equals(other.getModifyDate()))
				&& (this.getCheckNo() == null ? other.getCheckNo() == null
						: this.getCheckNo().equals(other.getCheckNo()))
				&& (this.getCheckName() == null ? other.getCheckName() == null
						: this.getCheckName().equals(other.getCheckName()))
				&& (this.getCheckDate() == null ? other.getCheckDate() == null
						: this.getCheckDate().equals(other.getCheckDate()))
				&& (this.getFromId() == null ? other.getFromId() == null : this.getFromId().equals(other.getFromId()))
				&& (this.getServTag() == null ? other.getServTag() == null
						: this.getServTag().equals(other.getServTag()))
				&& (this.getGoodsSample() == null ? other.getGoodsSample() == null
						: this.getGoodsSample().equals(other.getGoodsSample()))
				&& (this.getSampleGet() == null ? other.getSampleGet() == null
						: this.getSampleGet().equals(other.getSampleGet()))
				&& (this.getDocs() == null ? other.getDocs() == null : this.getDocs().equals(other.getDocs()))
				&& (this.getConfirm() == null ? other.getConfirm() == null
						: this.getConfirm().equals(other.getConfirm()))
				...
				&& (this.getManualNo() == null ? other.getManualNo() == null
						: this.getManualNo().equals(other.getManualNo()))
				&& (this.getPayTerm() == null ? other.getPayTerm() == null
						: this.getPayTerm().equals(other.getPayTerm()))
				&& (this.getOcId() == null ? other.getOcId() == null : this.getOcId().equals(other.getOcId()))
				&& (this.getIsInstall() == null ? other.getIsInstall() == null
						: this.getIsInstall().equals(other.getIsInstall()))
				&& (this.getTag() == null ? other.getTag() == null : this.getTag().equals(other.getTag()))
				&& (this.getGjTerm() == null ? other.getGjTerm() == null : this.getGjTerm().equals(other.getGjTerm()))
				&& (this.getNeedCalc() == null ? other.getNeedCalc() == null
						: this.getNeedCalc().equals(other.getNeedCalc()))
				...
				&& (this.getViewScope() == null ? other.getViewScope() == null
						: this.getViewScope().equals(other.getViewScope()))
				&& (this.getPrompt() == null ? other.getPrompt() == null : this.getPrompt().equals(other.getPrompt()))
				&& (this.getIsNeedSample() == null ? other.getIsNeedSample() == null
						: this.getIsNeedSample().equals(other.getIsNeedSample()))
				&& (this.getIsGetSample() == null ? other.getIsGetSample() == null
						: this.getIsGetSample().equals(other.getIsGetSample()))
				&& (this.getTrademode() == null ? other.getTrademode() == null
						: this.getTrademode().equals(other.getTrademode()))
				&& (this.getCurrType() == null ? other.getCurrType() == null
						: this.getCurrType().equals(other.getCurrType()))
				&& (this.getProId() == null ? other.getProId() == null : this.getProId().equals(other.getProId()))
				&& (this.getProType() == null ? other.getProType() == null
						: this.getProType().equals(other.getProType()))
				&& (this.getSendOverTag() == null ? other.getSendOverTag() == null
						: this.getSendOverTag().equals(other.getSendOverTag()))
				&& (this.getSendOverDate() == null ? other.getSendOverDate() == null
						: this.getSendOverDate().equals(other.getSendOverDate()))
				&& (this.getFctOrderNo() == null ? other.getFctOrderNo() == null
						: this.getFctOrderNo().equals(other.getFctOrderNo()))
				&& (this.getIsJsReal() == null ? other.getIsJsReal() == null
						: this.getIsJsReal().equals(other.getIsJsReal()))
				&& (this.getCheckUserId() == null ? other.getCheckUserId() == null
						: this.getCheckUserId().equals(other.getCheckUserId()))
				&& (this.getModifyUserId() == null ? other.getModifyUserId() == null
						: this.getModifyUserId().equals(other.getModifyUserId()))
				&& (this.getCopyPartyNo() == null ? other.getCopyPartyNo() == null
						: this.getCopyPartyNo().equals(other.getCopyPartyNo()))
				&& (this.getCopyPartyId() == null ? other.getCopyPartyId() == null
						: this.getCopyPartyId().equals(other.getCopyPartyId()))
				&& (this.getCopyMoveNo() == null ? other.getCopyMoveNo() == null
						: this.getCopyMoveNo().equals(other.getCopyMoveNo()))
				&& (this.getCopyMoveId() == null ? other.getCopyMoveId() == null
						: this.getCopyMoveId().equals(other.getCopyMoveId()))
				&& (this.getIsJqOver() == null ? other.getIsJqOver() == null
						: this.getIsJqOver().equals(other.getIsJqOver()))
				&& (this.getUndo() == null ? other.getUndo() == null : this.getUndo().equals(other.getUndo()))
				&& (this.getIsZyOver() == null ? other.getIsZyOver() == null
						: this.getIsZyOver().equals(other.getIsZyOver()))
				&& (this.getProducerId() == null ? other.getProducerId() == null
						: this.getProducerId().equals(other.getProducerId()))
				&& (this.getProducerNo() == null ? other.getProducerNo() == null
						: this.getProducerNo().equals(other.getProducerNo()))
				&& (this.getProducerName() == null ? other.getProducerName() == null
						: this.getProducerName().equals(other.getProducerName()))
				&& (this.getGdTag() == null ? other.getGdTag() == null : this.getGdTag().equals(other.getGdTag()))
				&& (this.getGdUserId() == null ? other.getGdUserId() == null
						: this.getGdUserId().equals(other.getGdUserId()))
				&& (this.getGdDate() == null ? other.getGdDate() == null : this.getGdDate().equals(other.getGdDate()))
				&& (this.getGjFctNo() == null ? other.getGjFctNo() == null
						: this.getGjFctNo().equals(other.getGjFctNo()))
				&& (this.getGjFctId() == null ? other.getGjFctId() == null
						: this.getGjFctId().equals(other.getGjFctId()))
				&& (this.getOcuOrgId() == null ? other.getOcuOrgId() == null
						: this.getOcuOrgId().equals(other.getOcuOrgId()))
				&& (this.getSendTerm() == null ? other.getSendTerm() == null
						: this.getSendTerm().equals(other.getSendTerm()))
				&& (this.getSendDay() == null ? other.getSendDay() == null
						: this.getSendDay().equals(other.getSendDay()))
				&& (this.getSendoverDay() == null ? other.getSendoverDay() == null
						: this.getSendoverDay().equals(other.getSendoverDay()))
				...
				&& (this.getTransWay() == null ? other.getTransWay() == null
						: this.getTransWay().equals(other.getTransWay()))
				...
				&& (this.getCstShortName() == null ? other.getCstShortName() == null
						: this.getCstShortName().equals(other.getCstShortName()))
				&& (this.getTransCorpId() == null ? other.getTransCorpId() == null
						: this.getTransCorpId().equals(other.getTransCorpId()))
				&& (this.getTransCorpName() == null ? other.getTransCorpName() == null
						: this.getTransCorpName().equals(other.getTransCorpName()))
				&& (this.getOtherReq() == null ? other.getOtherReq() == null
						: this.getOtherReq().equals(other.getOtherReq()))
				&& (this.getIsU8PurcharseReq() == null ? other.getIsU8PurcharseReq() == null
						: this.getIsU8PurcharseReq().equals(other.getIsU8PurcharseReq()))
				...
				&& (this.getCloseUserId() == null ? other.getCloseUserId() == null
						: this.getCloseUserId().equals(other.getCloseUserId()))
				&& (this.getCloseDate() == null ? other.getCloseDate() == null
						: this.getCloseDate().equals(other.getCloseDate()))
				&& (this.getIuOcuId() == null ? other.getIuOcuId() == null
						: this.getIuOcuId().equals(other.getIuOcuId()))
				&& (this.getInlandOrOverseas() == null ? other.getInlandOrOverseas() == null
						: this.getInlandOrOverseas().equals(other.getInlandOrOverseas()))
				&& (this.getTypeOfCon() == null ? other.getTypeOfCon() == null
						: this.getTypeOfCon().equals(other.getTypeOfCon()))
				&& (this.getCloseConfirm() == null ? other.getCloseConfirm() == null
						: this.getCloseConfirm().equals(other.getCloseConfirm()))
				&& (this.getDepOrgId() == null ? other.getDepOrgId() == null
						: this.getDepOrgId().equals(other.getDepOrgId()))
				&& (this.getPurchaserId() == null ? other.getPurchaserId() == null
						: this.getPurchaserId().equals(other.getPurchaserId()))
				&& (this.getCataOfCon() == null ? other.getCataOfCon() == null
						: this.getCataOfCon().equals(other.getCataOfCon()))
				&& (this.getPropOfCon() == null ? other.getPropOfCon() == null
						: this.getPropOfCon().equals(other.getPropOfCon()))
				&& (this.getBizMode() == null ? other.getBizMode() == null
						: this.getBizMode().equals(other.getBizMode()))
				&& (this.getRelBcId() == null ? other.getRelBcId() == null
						: this.getRelBcId().equals(other.getRelBcId()))
				&& (this.getConName() == null ? other.getConName() == null
						: this.getConName().equals(other.getConName()))
				&& (this.getValidDate() == null ? other.getValidDate() == null
						: this.getValidDate().equals(other.getValidDate()))
				&& (this.getSignPlace() == null ? other.getSignPlace() == null
						: this.getSignPlace().equals(other.getSignPlace()))
				&& (this.getConContent() == null ? other.getConContent() == null
						: this.getConContent().equals(other.getConContent()))
				&& (this.getSellerNationId() == null ? other.getSellerNationId() == null
						: this.getSellerNationId().equals(other.getSellerNationId()))
				&& (this.getSellerProp() == null ? other.getSellerProp() == null
						: this.getSellerProp().equals(other.getSellerProp()))
				&& (this.getSenderId() == null ? other.getSenderId() == null
						: this.getSenderId().equals(other.getSenderId()))
				&& (this.getLandNationId() == null ? other.getLandNationId() == null
						: this.getLandNationId().equals(other.getLandNationId()))
				&& (this.getLandPortId() == null ? other.getLandPortId() == null
						: this.getLandPortId().equals(other.getLandPortId()))
				&& (this.getLandLocation() == null ? other.getLandLocation() == null
						: this.getLandLocation().equals(other.getLandLocation()))
				&& (this.getRecerId() == null ? other.getRecerId() == null
						: this.getRecerId().equals(other.getRecerId()))
				&& (this.getDestNationId() == null ? other.getDestNationId() == null
						: this.getDestNationId().equals(other.getDestNationId()))
				&& (this.getDestPortId() == null ? other.getDestPortId() == null
						: this.getDestPortId().equals(other.getDestPortId()))
				&& (this.getDestLocation() == null ? other.getDestLocation() == null
						: this.getDestLocation().equals(other.getDestLocation()))
				&& (this.getIsBatches() == null ? other.getIsBatches() == null
						: this.getIsBatches().equals(other.getIsBatches()))
				&& (this.getIsTransfer() == null ? other.getIsTransfer() == null
						: this.getIsTransfer().equals(other.getIsTransfer()))
				&& (this.getTransferPortId() == null ? other.getTransferPortId() == null
						: this.getTransferPortId().equals(other.getTransferPortId()))
				&& (this.getCommissionId() == null ? other.getCommissionId() == null
						: this.getCommissionId().equals(other.getCommissionId()))
				&& (this.getCommissionRate() == null ? other.getCommissionRate() == null
						: this.getCommissionRate().equals(other.getCommissionRate()))
				&& (this.getCommissionCurrType() == null ? other.getCommissionCurrType() == null
						: this.getCommissionCurrType().equals(other.getCommissionCurrType()))
				&& (this.getCommissionFee() == null ? other.getCommissionFee() == null
						: this.getCommissionFee().equals(other.getCommissionFee()))
				&& (this.getShipmentWay() == null ? other.getShipmentWay() == null
						: this.getShipmentWay().equals(other.getShipmentWay()))
				&& (this.getBoxDeliveryType() == null ? other.getBoxDeliveryType() == null
						: this.getBoxDeliveryType().equals(other.getBoxDeliveryType()))
				&& (this.getDeliveryPlace() == null ? other.getDeliveryPlace() == null
						: this.getDeliveryPlace().equals(other.getDeliveryPlace()))
				&& (this.getIsPlanSt() == null ? other.getIsPlanSt() == null
						: this.getIsPlanSt().equals(other.getIsPlanSt()))
				&& (this.getProxyCorpId() == null ? other.getProxyCorpId() == null
						: this.getProxyCorpId().equals(other.getProxyCorpId()))
				&& (this.getTransResp() == null ? other.getTransResp() == null
						: this.getTransResp().equals(other.getTransResp()))
				&& (this.getTransFeeResp() == null ? other.getTransFeeResp() == null
						: this.getTransFeeResp().equals(other.getTransFeeResp()))
				&& (this.getTransInsuResp() == null ? other.getTransInsuResp() == null
						: this.getTransInsuResp().equals(other.getTransInsuResp()))
				&& (this.getArbitrationPlace() == null ? other.getArbitrationPlace() == null
						: this.getArbitrationPlace().equals(other.getArbitrationPlace()))
				&& (this.getSuePlace() == null ? other.getSuePlace() == null
						: this.getSuePlace().equals(other.getSuePlace()))
				&& (this.getIsNeedSpecDocu() == null ? other.getIsNeedSpecDocu() == null
						: this.getIsNeedSpecDocu().equals(other.getIsNeedSpecDocu()))
				&& (this.getPricingWay() == null ? other.getPricingWay() == null
						: this.getPricingWay().equals(other.getPricingWay()))
				&& (this.getPriceStandard() == null ? other.getPriceStandard() == null
						: this.getPriceStandard().equals(other.getPriceStandard()))
				&& (this.getExamStandard() == null ? other.getExamStandard() == null
						: this.getExamStandard().equals(other.getExamStandard()))
				&& (this.getConPeriod() == null ? other.getConPeriod() == null
						: this.getConPeriod().equals(other.getConPeriod()))
				&& (this.getBailRate() == null ? other.getBailRate() == null
						: this.getBailRate().equals(other.getBailRate()))
				&& (this.getProfitScheme() == null ? other.getProfitScheme() == null
						: this.getProfitScheme().equals(other.getProfitScheme()))
				&& (this.getCommQuantPack() == null ? other.getCommQuantPack() == null
						: this.getCommQuantPack().equals(other.getCommQuantPack()))
				&& (this.getCommQuantStat() == null ? other.getCommQuantStat() == null
						: this.getCommQuantStat().equals(other.getCommQuantStat()))
				&& (this.getcStatus() == null ? other.getcStatus() == null
						: this.getcStatus().equals(other.getcStatus()))
				&& (this.getCmdCataId() == null ? other.getCmdCataId() == null
						: this.getCmdCataId().equals(other.getCmdCataId()))
				&& (this.getPriceTerm() == null ? other.getPriceTerm() == null
						: this.getPriceTerm().equals(other.getPriceTerm()))
				&& (this.getFctName() == null ? other.getFctName() == null
						: this.getFctName().equals(other.getFctName()))
				&& (this.getPurchaserName() == null ? other.getPurchaserName() == null
						: this.getPurchaserName().equals(other.getPurchaserName()))
				&& (this.getSenderName() == null ? other.getSenderName() == null
						: this.getSenderName().equals(other.getSenderName()))
				&& (this.getRecerName() == null ? other.getRecerName() == null
						: this.getRecerName().equals(other.getRecerName()))
				&& (this.getCommissionName() == null ? other.getCommissionName() == null
						: this.getCommissionName().equals(other.getCommissionName()))
				&& (this.getProxyCorpName() == null ? other.getProxyCorpName() == null
						: this.getProxyCorpName().equals(other.getProxyCorpName()))
				&& (this.getAffectIncome() == null ? other.getAffectIncome() == null
						: this.getAffectIncome().equals(other.getAffectIncome()))
				&& (this.getAffectIncomeRate() == null ? other.getAffectIncomeRate() == null
						: this.getAffectIncomeRate().equals(other.getAffectIncomeRate()))
				&& (this.getManufacId() == null ? other.getManufacId() == null
						: this.getManufacId().equals(other.getManufacId()))
				&& (this.getManufacName() == null ? other.getManufacName() == null
						: this.getManufacName().equals(other.getManufacName()))
				&& (this.getU8OpId() == null ? other.getU8OpId() == null : this.getU8OpId().equals(other.getU8OpId()))
				&& (this.getCnyRate() == null ? other.getCnyRate() == null
						: this.getCnyRate().equals(other.getCnyRate()))
				&& (this.getUsdRate() == null ? other.getUsdRate() == null
						: this.getUsdRate().equals(other.getUsdRate()))
				&& (this.getCurrRate() == null ? other.getCurrRate() == null
						: this.getCurrRate().equals(other.getCurrRate()))
				&& (this.getShortOrOver() == null ? other.getShortOrOver() == null
						: this.getShortOrOver().equals(other.getShortOrOver()))
				&& (this.getConPeriodSType() == null ? other.getConPeriodSType() == null
						: this.getConPeriodSType().equals(other.getConPeriodSType()))
				&& (this.getCommUnit() == null ? other.getCommUnit() == null
						: this.getCommUnit().equals(other.getCommUnit()))
				&& (this.getTradeOrSrv() == null ? other.getTradeOrSrv() == null
						: this.getTradeOrSrv().equals(other.getTradeOrSrv()))
				&& (this.getTrSrvOrGoods() == null ? other.getTrSrvOrGoods() == null
						: this.getTrSrvOrGoods().equals(other.getTrSrvOrGoods()))
				&& (this.getProfitSchemeDesc() == null ? other.getProfitSchemeDesc() == null
						: this.getProfitSchemeDesc().equals(other.getProfitSchemeDesc()))
				&& (this.getComplexLevel() == null ? other.getComplexLevel() == null
						: this.getComplexLevel().equals(other.getComplexLevel()))
				...
				&& (this.getPlanSalesInlOrOs() == null ? other.getPlanSalesInlOrOs() == null
						: this.getPlanSalesInlOrOs().equals(other.getPlanSalesInlOrOs()))
				&& (this.getGjFctName() == null ? other.getGjFctName() == null
						: this.getGjFctName().equals(other.getGjFctName()))
				&& (this.getHolderId() == null ? other.getHolderId() == null
						: this.getHolderId().equals(other.getHolderId()))
				&& (this.getHolderName() == null ? other.getHolderName() == null
						: this.getHolderName().equals(other.getHolderName()))
				&& (this.getBizType() == null ? other.getBizType() == null
						: this.getBizType().equals(other.getBizType()));
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((getPlanSalesInlOrOs() == null) ? 0 : getPlanSalesInlOrOs().hashCode());
		result = prime * result + ((getGjFctName() == null) ? 0 : getGjFctName().hashCode());
